                    ...
                    <div className="py-6">
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                            ...
                            <div className="flex flex-col sm:flex-row gap-3 sm:items-center">
                                ...
                                <Link href={"/addProducts"}><button className="flex cursor-pointer items-center gap-2 px-4 py-2 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition-colors">
